...
//            @Override
//            public void safeValue(long l) throws Exception {
//                sum[0] += l;
//            }
//        });//each -> sum[0] += each);
//
...
//        Assert.assertTrue(iterable.anySatisfy(new LongPredicate() {
//            @Override
...
//        LongIterable iterable = this.newWith(0L, 1L, 2L);
//        Assert.assertFalse(iterable.allSatisfy(new LongPredicate() {
//            @Override
//            public boolean accept(long l) {
//                return 3L <  l ;
//            }
...
//        LongIterable iterable = this.newWith(0L, 1L, 2L);
//        Assert.assertFalse(iterable.noneSatisfy(
//                new LongPredicate() {
//                    @Override
//                    public boolean accept(long l) {
//                        return 1L < l;
...
//    public void collect()
//    {
//        LongToObjectFunction<Long> function = new LongToObjectFunction<Long>() {
//            @Override
