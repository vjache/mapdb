...
//        MutableLongSet set = this.newWith(0L, 1L, 31L, AbstractLongSetTestCase.generateCollisions1().getFirst(), AbstractLongSetTestCase.generateCollisions1().get(1));
//        final LongIterator iterator = set.longIterator();
...
//        Long sum = set.injectInto(Long.valueOf(0L),
//                new ObjectLongToObjectFunction<Long, Long>() {
//                    @Override
//                    public Long valueOf(Long result, long value) {
//                        return Long.valueOf((long) (result + value));
//                    }
//                });//(Long result, long value) -> Long.valueOf((long) (result + value)));
...
//        MutableLongSet set = this.newWith(0L, 1L, 31L, AbstractLongSetTestCase.generateCollisions1().getFirst(), AbstractLongSetTestCase.generateCollisions1().get(1));
//        set.forEach(new CheckedLongProcedure() {
//            @Override
//            public void safeValue(long each) throws Exception {
//                sum[0] += each;
//            }
//        });//(long each) -> sum[0] += each);
//
...
//            set.collect(new LongToObjectFunction<Object>() {
//                @Override
//                public Object valueOf(long byteParameter) {
//                    return byteParameter - 1;
//                }
//            }));//(long byteParameter) -> byteParameter - 1));
//    }
//
//    @Override
//    @Test
